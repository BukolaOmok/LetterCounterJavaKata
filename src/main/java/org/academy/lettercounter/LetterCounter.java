...
public class LetterCounter {
    ...
    public List<String> generateReport() {
        ...
        Set<Character> letters = counts.keySet(); // why would i use set when i already have the function in count one letter that already allows me to say it should skip adding a letter that already exists and instead replace it and increment the value?
